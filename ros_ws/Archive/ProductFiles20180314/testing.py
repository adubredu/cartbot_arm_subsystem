...
lLimb.set_joint_positions(endOfOpen)
lLimb.set_joint_positions(endOfOpen)
lLimb.set_joint_positions(endOfOpen)
lLimb.set_joint_positions(endOfOpen)
time.sleep(5)
tasks.getFoodContainer(lLimb, rLimb, lGripper, pause_event)
time.sleep(2)
tasks.placeFoodContainerInMicrowave(lLimb, rLimb, lGripper, pause_event)
tasks.closeMicrowave(lLimb, rLimb, pause_event)